...
.speakers { background: $color-bg-opacity-green; }
...
.speakers_header {
  ...
  .button  {
    ...
    .button-text { color: $color-text-dark; }
  }
}
...
@media (max-width: 1200px) {
  .speakers_content .speakers_content-item {
    flex: 0 0 50%;
    max-width: 50%;
  }
}
